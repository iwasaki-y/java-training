...
public class CarTester2 {
	...
	public static void main(String[] args) {
		...
		System.out.print("ナ    ン   バー:"); String number = stdIn.next();
		...
		System.out.print("タ ン ク 容量:"); double tank = stdIn.nextDouble();
		System.out.print("ガ  ソ リ ン量:"); double fuel = stdIn.nextDouble();
		System.out.print("燃           料:"); double sfc = stdIn.nextDouble();
